...
public class PaymentService {
  ...
  /**
   * Note: the DB write and the stream publish below are not atomic (the classic "dual write"
   * problem). If the process crashes between save() and the stream add, the payment is stuck in
   * PENDING forever. Fine for a learning project; a production system would use an outbox pattern.
   */
  @Transactional
